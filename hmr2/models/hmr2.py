...
class HMR2(pl.LightningModule):
    ...
    def forward_step(self, batch: Dict, train: bool = False) -> Dict:
        ...
        print("Predicted 3D keypoints",pred_keypoints_3d)
        print("Predicted 2D keypoints",pred_keypoints_2d)
        print("Predicted SMPL parameters (body pose)",pred_smpl_params['body_pose'])
        print("Predicted SMPL parameters (global_orient)",pred_smpl_params['global_orient'])
        print("Predicted SMPL parameters (betas)",pred_smpl_params['betas'])
